...
# 
# Usage:
#   bash <(curl -s https://raw.githubusercontent.com/awslabs/cli-agent-manager/main/tmux-install.sh)
#   or
...
# Configuration
readonly TMUX_CONF_URL="https://raw.githubusercontent.com/awslabs/cli-agent-manager/main/.tmux.conf"
