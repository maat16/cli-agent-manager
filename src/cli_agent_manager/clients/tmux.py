...
from cli_agent_manager.constants import TMUX_HISTORY_LINES
...
class TmuxClient:
    ...
    def create_session(self, session_name: str, window_name: str, terminal_id: str) -> str:
        ...
        try:
            ...
            environment["TRON_TERMINAL_ID"] = terminal_id
    ...
    def create_window(self, session_name: str, window_name: str, terminal_id: str) -> str:
        ...
        try:
            ...
            window = session.new_window(
                window_name=window_name, environment={"TRON_TERMINAL_ID": terminal_id}
            )
