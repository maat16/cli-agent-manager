...
from cli_agent_manager.models.kiro_agent import KiroAgentConfig
from cli_agent_manager.models.provider import ProviderType
from cli_agent_manager.models.q_agent import QAgentConfig
...
def install(agent_source: str, provider: str):
    ...
    try:
        ...
        if local_profile.exists():
            ...
            agent_store = resources.files("cli_agent_manager.agent_store")
